        ...
        return (
            <ShowView className={'class-view class-show'}>
                ...
                <p className={'state-message'}>
                    { isLoading ? 'Loading...' : isError ? 'Failed to load Class Details.' : 'Class Details not found.' }
                </p>
            </ShowView>
        )
    }
    ...
    return (
        <ShowView className={'class-view class-show'}>
            ...
            <div className={'banner'}>
                {bannerUrl ? (<AdvancedImage alt={'classBanner'} cldImg={bannerPhoto(bannerCldPubId?? '', name)}/>) : <div className={'placeholder'} />}
            </div>
            ...
            <Card className={'details-card'}>
                ...
                <div className={'details-grid'}>
                    <div className={'instructor'}>
                        <p>Instructor</p>
                        <div>
                            <img src={teacher?.image ?? placeholderUrl} alt={'TeacherProfile'} />
                ...
                <div className={'join'}>
                    ...
                    <ol>
                        <li>Ask for the Invite code</li>
                        <li>Click on <i>Join Class</i> Button</li>
                        <li>Paste code and Join!</li>
                    </ol>
                </div>
